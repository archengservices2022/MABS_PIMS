...
class _PostAnnouncementScreenState extends State<PostAnnouncementScreen> {
  ...
  Future<void> _shareReferralOld(String referralCode) async {
    final String message = "Join Fitness Hub! 💪\n"
      ...
      "Download the app here: https://play.google.com/store/apps/details?id=com.flexfacility.app&referrer=referral_code%3D$referralCode";
  ...
  Future<void> _shareReferral() async {
    ...
    final String message = "Join Fitness Hub! 💪\n"
      ...
      "New members get a special discount 🎉\n\n"
      "Download the app here: https://play.google.com/store/apps/details?id=com.flexfacility.app&referrer=referral_code%3D$userReferralCode";
    final String subject = "Fitness App Referral";
  ...
  Future<void> _copyReferralLink() async {
    ...
    final String referralLink = "https://play.google.com/store/apps/details?id=com.flexfacility.app&referrer=referral_code%3D$userReferralCode";
